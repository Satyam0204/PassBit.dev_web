...
function MobileNav({open,setOpen}){
    return (
        <div className={` text-white absolute top-0 left-0 h-screen w-screen transform ${open ? "-translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out filter drop-shadow-md `}>
...
function Navbar(){
    ...
    return (
        <nav  className=" text-white flex filter drop-shadow-md  px-4 py-2 h-20.5 items-center border-solid border-b-2 border-sky-200">
            ...
            <div className="w-2/12 flex items-center mx-2">
                <a className="text-2xl font-semibold my-3" href="/"><Image src="/assets/passbit-website-navbar.png" width={170} height={170}/></a>
            </div>
