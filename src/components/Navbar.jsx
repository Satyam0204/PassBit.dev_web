...
function MobileNav({open,setOpen}){
    return (
        <div className={` bg-slate-900 z-20 text-white absolute top-0 left-0 h-screen w-screen transform ${open ? "-translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out filter drop-shadow-md `}>
            ...
            <div className="h-20"> 
            <div className="w-6/12 mx-8 my-3 md:hidden flex items-center ">
                <a className="text-1xl font-semibold my-3" href="/">
    ...
    return (
        <nav  className=" text-white flex filter drop-shadow-md  px-4 py-2 h-20.5 items-center border-solid border-b-2 border-sky-200">
            ...
            <div className="w-10/12 flex justify-end md:justify-center items-center ">
                ...
                <a className="text-1xl font-medium my-4 mx-3" href="/about" onClick={() => setTimeout(() => {setOpen(!open)}, 100)}>
                    All Passwords
                </a>
                <a className="text-1xl font-medium my-4 mx-3" href="/about" onClick={() => setTimeout(() => {setOpen(!open)}, 100)}>
                    Generate Password
                ...
                <a className="text-1xl font-medium my-4 mx-3" href="/contact" onClick={() => setTimeout(() => {setOpen(!open)}, 100)}>
                   Security
                </a>
                <a className="text-1xl font-medium my-4 mx-3" href="/contact" onClick={() => setTimeout(() => {setOpen(!open)}, 100)}>
                   Contact Us
            ...
            <a className="text-1xl font-medium my-4 mx-3  hidden lg:block lg:visible" href="/contact" onClick={() => setTimeout(() => {setOpen(!open)}, 100)}>
                   Login
                </a>
            </div>
